...
type CreateShortURLRequest struct {
	OriginalURL string     `json:"original_url"           binding:"required" example:"https://example.com/very/long/url"`
	CustomAlias *string    `json:"custom_alias,omitempty"                    example:"my-link"`
	ExpiresAt   *time.Time `json:"expires_at,omitempty"                      example:"2023-10-27T10:00:00Z"`
}
...
type AnalyticsResponse struct {
	...
	RecentClicks      []ClickDetail    `json:"recent_clicks"`
	CreatedAt         time.Time        `json:"created_at"           example:"2023-10-27T10:00:00Z"`
}
...
type ClickDetail struct {
	...
	ClickedAt time.Time `json:"clicked_at"        example:"2023-10-27T10:00:00Z"`
}
...
type ErrorResponse struct {
	...
	Details string `json:"details,omitempty" example:"link with short_code does not exist"`
}
